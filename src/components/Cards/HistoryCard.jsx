...
const HistoryCard = ({ video, deleteHistoryVideo }) => {
    const{
        _id,
        title,
        description,
    ...
    const handleDeleteHistoryVideo = () => {
        deleteHistoryVideo(_id)
    }
        ...
        <div className="card card-box-shadow video-card">
            ...
            <section className="video-card-details">
                ...
                <section className="video-card-btn-section">
                    ...
                    <button className="btn card-delete video-card-delete cp" onClick={handleDeleteHistoryVideo} >
